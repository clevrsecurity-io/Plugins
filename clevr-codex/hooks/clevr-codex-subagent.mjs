#!/usr/bin/env node
// clevr-codex-subagent.mjs — Codex (SubagentStart) hook.
//
...
const candidates = [join(here, '..', 'claude-code', 'clevr-subagent.mjs'), join(here, '..', '..', 'claude-code', 'hooks', 'clevr-subagent.mjs')];
